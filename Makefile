...
build-main: $(SRCS) $(MAINTARGETS)
	$(foreach file, $(MAINTARGETS), $(shell gcc -Ipkg/bst -Ipkg/schedule -pedantic -Wextra -Wunused -std=c11 -lm -g -Wall $(file) $(SRCS) -fsanitize=address -o bin$(patsubst %.c,/%.o,$(notdir  $(file)))))
