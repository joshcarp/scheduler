...
{	
	node_t *head = newNode(newData("0", 0, NULL));
	bstInsert(head, newData("1", 0, NULL));
	bstInsert(head, newData("3", 0, NULL));
	bstInsert(head, newData("2", 0, NULL));
...
void test_PrintKey(void)
{
	...
	bstInsert(head, newData("2018-3",0,NULL));
	bstInsert(head, newData("2018-2",0,NULL));
	bstInsert(head, newData("2018-1",0,NULL));
	bstInsert(head, newData("2018-1",0,NULL));
	bstInsert(head, newData("2019-4",0,NULL));
	bstInsert(head, newData("2018-1",0,NULL));
	bstInsert(head, newData("2018-1",0,NULL));
	bstInsert(head, newData("2018-3",0,NULL));
	bstInsert(head, newData("2018-2",0,NULL));
